...
- **Automation**: [ttfs/config-triangle2-entity-sds.json](https://github.com/lucmoreau/provenance-templates/blob//src/main/resources/ttfs/config-triangle2-entity-sds.json)
