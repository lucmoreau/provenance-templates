...
- **Automation**: [ttfs/config-removing-from-collection.json](https://github.com/lucmoreau/provenance-templates/blob/src/main/resources/ttfs/config-removing-from-collection.json)
