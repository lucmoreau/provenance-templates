...
- **Details**:
    ...
    As this is a physical operation, the container and item specialisations have a single existence. The creation of `item1` and `container1` invalidates (in the sense of provenance)  `item0` and `container0`, though we did not make invalidation edges explicit to avoid overloading the visualisation.
