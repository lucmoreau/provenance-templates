...
- **Design considerations**: The ability to assert new attributes for this agent.
- **Automation**:   [ttfs/config-triangle2-agent-sds.json](file:project/template-intro1/src/main/resources/ttfs/config-triangle2-agent-sds.json)
