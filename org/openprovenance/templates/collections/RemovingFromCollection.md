...
- **IRI**: <https://openprovenance.org/templates/collections/RemovingFromCollection>
...
- **Automation**: [ttfs/config-removing-from-collection.json](project/template-intro1/src/main/resources/ttfs/config-removing-from-collection.json)
...
- **Details**:
    ...
    - Triangle1-Entity-UGD describes the item `item0` initially not belonging to the collection 
      and becoming the item `item1` included in the collection, with all other aspects of the 
      item unchanged.
