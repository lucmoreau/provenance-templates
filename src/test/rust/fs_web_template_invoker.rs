...
pub struct FsWebTemplateInvoker {
    pub url: String,
...
impl InputOutputProcessor for FsWebTemplateInvoker {
...
pub type RemoteEnactor = BeanHistory<FsWebTemplateInvoker>;
...
pub fn new_remote_enactor(
    ...
    BeanHistory::new(
        FsWebTemplateInvoker::new(url, access_token).with_debug(debug),
        Vec::new(),
    )
}
