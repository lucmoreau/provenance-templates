...
import org.openprovenance.templates.catalogue.fs.integrator.TemplateInvoker;
...
public class FS_WebTemplateInvoker extends TemplateInvoker {
    static Logger logger = LogManager.getLogger(FS_WebTemplateInvoker.class);
    ...
    public FS_WebTemplateInvoker(String url, boolean authorizer) {
        super();
        this.url=url;
