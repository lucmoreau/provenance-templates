...
/**
 * openprov.jsonld extends the PROV-JSONLD context by redefining three type-scoped terms, and JSON-LD replaces a
...
public class OpenprovContextTest extends TestCase {
    ...
    static final List<String> EXTENDED = List.of("Attribution", "Membership", "Specialization");
    ...
    /** The extension redefines the three extended types and nothing else of the specification's. */
