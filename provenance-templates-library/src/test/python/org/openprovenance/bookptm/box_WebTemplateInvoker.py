from org.openprovenance.templates.catalogue.transport.integrator.TemplateInvoker import TemplateInvoker
...
def postInstructionsInOut(url, inputs0, access_token):
    ...
    print(f"Posting payload: {payload.decode('utf-8')}")
    headers = {
...
class WebTemplateInvoker(TemplateInvoker):
    ...
    def process_transporting_inputs(self, bean):
        ...
        out = TemplateInvoker.process_transporting_inputs(self,bean)
    ...
    def process_handingover_inputs(self, bean):
        # Call the parent's process method to get the output
        out = TemplateInvoker.process_handingover_inputs(self,bean)
    ...
    def process_weighing_inputs(self, bean):
        # Call the parent's process method to get the output
        out = TemplateInvoker.process_weighing_inputs(self,bean)
    ...
    def process_agent_init_inputs(self, bean):
        # Call the parent's process method to get the output
        out = TemplateInvoker.process_agent_init_inputs(self,bean)
    ...
    def process_item_init_inputs(self, bean):
        # Call the parent's process method to get the output
        out = TemplateInvoker.process_item_init_inputs(self,bean)
    ...
    def process_packing_inputs(self, bean):
        # Call the parent's process method to get the output
        out = TemplateInvoker.process_packing_inputs(self,bean)
    ...
    def process_packing_composite_inputs(self, bean):
        # Call the parent's process method to get the output
        out = TemplateInvoker.process_packing_composite_inputs(self,bean)
    ...
    def process_unpacking_inputs(self, bean):
        # Call the parent's process method to get the output
        out = TemplateInvoker.process_unpacking_inputs(self,bean)
    ...
    def process_unpacking_composite_inputs(self, bean):
        # Call the parent's process method to get the output
        out = TemplateInvoker.process_unpacking_composite_inputs(self,bean)
